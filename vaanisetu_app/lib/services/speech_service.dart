...
class SpeechService extends ChangeNotifier {
  ...
  Future<void> _initTTS() async {
    // List available voices to terminal so you can find your custom one
    try {
      List<dynamic> voices = await _flutterTts.getVoices;
      for (var voice in voices) {
        if (voice["locale"].toString().contains("ta")) {
          debugPrint("🔊 Found Tamil Voice: ${voice["name"]} (${voice["locale"]})");
        }
      }
    } catch (e) {
    ...
    // ─── TIP: To use your custom voice, uncomment and update the line below:
    // await _flutterTts.setVoice({"name": "YOUR_VOICE_NAME", "locale": "ta-IN"});
